...
Future Stud_online_exam(String stdid, String stoken, String uid) async {
  var uri = '';
  if (schoolcode == '') {
    SharedPreferences initialschoolcode = await SharedPreferences.getInstance();
    var url = initialschoolcode.getString('url').toString();
    uri = '${url}webservice/getonlineexam';
  }
  if (schoolcode != '') {
    uri = "https://$schoolcode.$baseurl/webservice/getonlineexam";
  }
  //debugPrint('url- $uri');
