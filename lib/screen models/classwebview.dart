...
class Class_Web extends StatefulWidget {
  final String urii;
  const Class_Web({required this.urii});

  @override
  _Class_WebState createState() => new _Class_WebState();
}

class _Class_WebState extends State<Class_Web> {
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushReplacement(
                        context,
                        CupertinoPageRoute(
                            builder: (BuildContext context) => OnlineClass()));
                  },
                ),
                SizedBox(
                  width: 10,
